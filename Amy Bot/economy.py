...
class economy(commands.Cog):
    ...
    async def balance(self,ctx):
        ...
        embed.add_field(name = "Wallet Balance", value = "{} amyla".format(wallet_amt))
        embed.add_field(name = "Bank Balance", value = "{} amyla".format(bank_amt))
    ...
    async def beg(self,ctx):
        ...
        await ctx.send("Someone gave you {} amyla!".format(earnings))
    ...
    async def daily(self,ctx):
        ...
        await ctx.send("Your daily reward is {} amyla!".format(earnings))
    ...
    async def deposit(self,ctx,amount = None):
        ...
        await ctx.send("You deposited {} amyla!".format(amount))
    ...
    async def withdraw(self,ctx,amount = None):
        ...
        await ctx.send("You withdrew {} amyla!".format(amount))
    ...
    async def send(self,ctx,member:discord.Member,amount = None):
        ...
        await ctx.send("You gave {} {} amyla!".format(member,amount))
    ...
    async def slots(self,ctx,amount = 1):
        ...
        if (slots1 == slots2 and slots2 == slots3):
            if slots1 == "<:weh:823640574874746960>":
                ...
                embed = discord.Embed(
                    description = "{} rolled: {}{}{}. They won {} amyla!".format(ctx.author,slots1,slots2,slots3,50*amount),
                    colour = discord.Colour.blurple()
                )
                await ctx.send(embed=embed)
            else:
                ...
                embed = discord.Embed(
                    description = "{} rolled: {}{}{}. They won {} amyla!".format(ctx.author,slots1,slots2,slots3,20*amount),
                    colour = discord.Colour.blurple()
                )
                await ctx.send(embed=embed)
        else:
            await update_bank(ctx.author,-1*amount)
            embed = discord.Embed(
                description = "{} rolled: {}{}{}. They lost {} amyla!".format(ctx.author,slots1,slots2,slots3,amount),
                colour = discord.Colour.blurple()
            )
            await ctx.send(embed=embed)
    ...
    async def shop(self,ctx):
        ...
        embed.set_footer(text = "These are the season 1 items available for purchase on Amy Bot. Shop resets 5/31/2021")
    ...
    async def buy(self, ctx,*, item = None,):
        ...
        if item == None:
            await ctx.send("Please include which item to buy!")
            return
    ...
    async def sell(self,ctx,*,item = None,amount = 1):
        ...
        if item == None:
            await ctx.send("Please include which item to sell!")
            return
    ...
    @commands.command(aliases=["properties","p"])
    ...
    @commands.command(aliases = ["shopp"])
    async def shopproperty(self,ctx):
        embed = discord.Embed(
            title = "Property Shop",
    ...
    @commands.command(aliases = ["buyp"])
    async def buyproperty(self,ctx, item=None, amount = 1):
        if item == None:
            await ctx.send("Please include which property to buy!")
            return
        await open_account(ctx.author)
    ...
    @commands.command(aliases = ["sellp"])
    async def sellproperty(self, ctx,item=None,amount = 1):
        await open_account(ctx.author)

        if item == None:
            await ctx.send("Please include which property to sell!")
            return
