...
class utility(commands.Cog):
  ...
  async def suggest(self,ctx):
    ...
    embed.set_footer(text = 'Thank you for the support! Amy bot is a community effort and needs your ideas!')
    await ctx.send(embed=embed)

  @commands.command()
  async def invite(self, ctx):
    embed = discord.Embed(
      description = "Thank you for inviting me! Go to this link to invite me to one of your servers: {}".format("https://discord.com/api/oauth2/authorize?client_id=830102253339017296&permissions=0&scope=bot"),
      colour = discord.Colour.green()
    )
    embed.set_footer(text = 'Thank you for inviting Amy Bot!')
    await ctx.send(embed=embed)
